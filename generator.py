...
## topic 怎么写
- **人称跟 story 一致**：第三人称，主语是 Mittes。整段日程给她的所有信息都是这一套人称，
  混着写会显得别扭
- 30~60 字，**必须带前因后果**——这是一件能讲的事，不是一个标签
  - ✗ Sweyn 给了根皮筋（压成了名词短语，看不出为什么、后来怎样）
  - ✓ Mittes 的猫耳发卡橡皮筋临营业前崩断，翻遍抽屉都没有备用的，Sweyn 从吧台递来一根黑皮筋，还替她别好翘起的那缕头发
  - ✗ 麦克风只有一支有电（只有状况，没有她怎么应对）
  - ✓ Mittes 和朋友进了包厢才发现两支麦克风只有一支有电，两个人挤在一块儿轮着唱，到最后嗓子都哑了
