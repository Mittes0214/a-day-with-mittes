...
# story 里就会冒出心理旁白，把"发生了一件事"稀释成一段内心戏。
...
- **第三人称叙述，主语是 Mittes**，100~150 字。首句里要出现「Mittes」这个名字
- 这段时间里要真的**发生一件事**——有起因、有推进、有一点小转折，不是定格一帧画面
  - ✗ 端着托盘在桌椅间穿行，裙摆随脚步轻轻摇晃
  - ✓ 四号桌那份蛋包饭要画小熊，手一抖把耳朵画歪了半边，正想擦掉重来，客人先笑出声，说这只反而更可爱。后来那一晚照着这只歪耳朵的又画了三份
- 规模要小，不写戏剧性的大事
- 必须和骨架的地点、服装、同处一致；同处里有人时，让这个人真的参与进事情里
- 承接上一个时段靠物件和动作的延续，不靠心理旁白；**一样东西最多接一两段就该退场**，别让它贯穿一整天、更不能跨天"""
...
- 50~80 字，要有**起因 → 发生了什么 → 结果或转折**
  ...
  - ✓ Mittes 的猫耳发卡橡皮筋临营业前崩断，翻遍抽屉都没有备用的，Sweyn 从吧台递来一根黑皮筋，还替她别好翘起的那缕头发
